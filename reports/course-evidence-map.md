...
| Integrated project evidence | `docs/final-project-dual-modem-implementation-report.md`, `reports/hardware/qpsk-fabric-loopback-qualification-20260707.md` | Measured internal QPSK proof | Timing-clean QPSK payload reaches BER=0 across 4/4 boot sessions and 13/13 selected-offset attempts | Add external RF metrics |
