...
| Integrated project evidence | `docs/final-project-dual-modem-implementation-report.md`, `reports/hardware/qpsk-fabric-loopback-qualification-20260707.md`, `reports/hardware/qpsk-rtl-sdr-qualification-20260707.md` | Measured internal and external QPSK proof | Timing-clean payload passes 4/4 internal boot sessions; RTL-SDR recovers a selected 280-bit OTA frame at BER=0 | Add multi-frame RF statistics |
