...
| Integrated project evidence | `docs/final-project-dual-modem-implementation-report.md`, `reports/hardware/qpsk-fabric-loopback-qualification-20260707.md`, `reports/hardware/qpsk-rtl-sdr-qualification-20260707.md` | Measured internal and external QPSK proof | Timing-clean payload passes 4/4 internal boot sessions; RTL-SDR detects 30/30 OTA bursts with 0/8,400 errors | Add cross-session and controlled-path statistics |
