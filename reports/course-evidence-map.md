...
| Block 5 HDL evidence | `reports/fpga/`, `blocks/block_05_fpga_hdl_flow/`, CI workflows | Measured signoff candidate | 18 RTL tests plus a fully routed, timing-clean and board-qualified snapshot; strategy sweep selects WNS +0.096 ns | Check repeat-build/seed stability |
...
| Integrated project evidence | `docs/final-project-dual-modem-implementation-report.md`, `reports/hardware/qpsk-fabric-loopback-qualification-20260707.md`, `reports/hardware/qpsk-rtl-sdr-qualification-20260707.md` | Measured internal and external QPSK proof | Selected ExtraTiming payload passes 10/10 fabric attempts; RTL-SDR baseline passes 3/3 OTA sessions, 90/90 bursts and 0/25,200 bits | Add controlled-path and longer-duration statistics on a stable capture backend |
...
4. Extend the filled implementation report with publication-cleared RF measurements and stable longer-duration captures.
