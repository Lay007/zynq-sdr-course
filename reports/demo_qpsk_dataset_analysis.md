...
The dataset is synthetic. It contains no off-air content, is published as a 64 KiB Git LFS payload and can be regenerated byte-for-byte from deterministic seed `7020`.
...
- zero symbol and bit errors over 2048 symbols / 4096 bits;
...
2. **Published synthetic deterministic QPSK fixture** — useful for direct replay plus CI-safe, legally clean and fully reproducible analysis.
