...
Flash#Quad SPI Flash#GPIO#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet\
...
0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0}\
  ...
  connect_bd_net -net sys_200m_clk [get_bd_pins axi_ad9361/delay_clk] [get_bd_pins sys_200m_rstgen/slowest_sync_clk] [get_bd_pins sys_ps7/FCLK_CLK1]
