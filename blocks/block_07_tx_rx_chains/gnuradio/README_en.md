...
## Purpose
This folder is intended for flowgraph models that make it easy to visualize the chain, repeat captures, and validate real-time behavior for Block 7 “Transmit and Receive Chains”.

## What should be stored here
- materials that directly support the block topics: transmit-chain structure; receive-chain structure; DUC and DDC;
...
- the materials should help the student reach at least one outcome of the block: chain block diagram, interface and sampling-rate table.
