# MATLAB Scripts and Analysis Scenarios

## Purpose
This folder is intended for numerical experiments, analysis scripts, and plot generation that can be inserted into reports for Block 1 “Introduction to SDR, Tools, and First Signal Reception”.
