# Measurement and Model Screenshots

## Purpose
This folder stores screenshots from HDSDR, MATLAB, Simulink, GNU Radio, KiCad, and related tools for Block 1 “Introduction to SDR, Tools, and First Signal Reception”.
...
- `block_1_spectrum_capture.png`
- `block_1_model_capture.png`
- `block_1_analysis_capture.png`
