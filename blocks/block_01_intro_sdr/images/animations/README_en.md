# Short Parameter-Change Animations

## Purpose
This folder stores short GIF or MP4 animations for effects that are hard to explain with one static image for Block 1 “Introduction to SDR, Tools, and First Signal Reception”.
