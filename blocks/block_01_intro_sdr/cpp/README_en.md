...
## Purpose
This folder is intended for efficient console utilities, data-stream readers, and checks of formats or processing algorithms for Block 1 “Introduction to SDR, Tools, and First Signal Reception”.
...
- `intro_tool.cpp`
- `iq_capture_estimator.cpp`
- `tone_lab_stream_checker.cpp`
