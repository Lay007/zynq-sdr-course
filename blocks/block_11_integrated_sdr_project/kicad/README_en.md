...
## Purpose
This folder is intended for schematics, KiCad projects, and electrical notes that connect the digital part of the course with real wiring and helper circuits for Block 11 “Integrated SDR Project”.
