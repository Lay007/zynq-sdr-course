...
## Purpose
This folder is intended for flowgraph models that make it easy to visualize the chain, repeat captures, and validate real-time behavior for Block 2 “Signals, Spectrum, Sampling, and I/Q”.

## What should be stored here
- materials that directly support the block topics: continuous and discrete signals; frequency-domain view and bandwidth; sampling rate and aliasing;
...
- the materials should help the student reach at least one outcome of the block: time-domain and spectrum plots, sampling-parameter table.
