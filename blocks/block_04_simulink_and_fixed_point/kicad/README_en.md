...
## Purpose
This folder is intended for schematics, KiCad projects, and electrical notes that connect the digital part of the course with real wiring and helper circuits for Block 4 “Simulink and Fixed-Point Preparation”.

## What should be stored here
- materials that directly support the block topics: chain modeling in Simulink; fixed-point representation and quantization; scaling and normalization;
...
- the materials should help the student reach at least one outcome of the block: data-format table, fixed-point error plots.
