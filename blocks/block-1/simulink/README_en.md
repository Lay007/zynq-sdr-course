...
## Purpose
This folder is intended for Simulink models that demonstrate the key ideas of the block through reproducible scenarios for Block 1 “Introduction to SDR, Tools, and First Signal Reception”.
