# Diagrams, Block Schemes, and Signal Routes

## Purpose
This folder stores vector diagrams of the signal chain, architecture, and experiment flow for Block 1 “Introduction to SDR, Tools, and First Signal Reception”.
