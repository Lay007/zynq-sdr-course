...
## Purpose
This folder is intended for Simulink models that demonstrate the key ideas of the block through reproducible scenarios for Block 6 “RF Frontend and AD9363”.
...
- `rf_frontend_demo.slx`
- `gain_plan_experiment.slx`
- `ad9363_analysis.slx`
