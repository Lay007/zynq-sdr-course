...
## Purpose
This folder should contain parameter tables, helper data, reference notes, and small reusable artifacts that support the block laboratories for Block 3 “DSP Basics”.
