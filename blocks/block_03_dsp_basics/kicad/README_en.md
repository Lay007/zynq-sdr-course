...
## Purpose
This folder is intended for schematics, KiCad projects, and electrical notes that connect the digital part of the course with real wiring and helper circuits for Block 3 “DSP Basics”.

## What should be stored here
- materials that directly support the block topics: FFT and spectrum interpretation; window functions and spectral leakage; FIR and IIR filters;
...
- the materials should help the student reach at least one outcome of the block: spectra before and after processing, filter parameters.
