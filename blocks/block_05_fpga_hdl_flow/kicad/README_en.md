...
## Purpose
This folder is intended for schematics, KiCad projects, and electrical notes that connect the digital part of the course with real wiring and helper circuits for Block 5 “HDL/FPGA Flow and Xilinx Tools”.

## What should be stored here
- materials that directly support the block topics: HDL-friendly model constraints; HDL generation from Simulink; testbench and functional verification;
...
- the materials should help the student reach at least one outcome of the block: structural chain diagram, interface and register map.
