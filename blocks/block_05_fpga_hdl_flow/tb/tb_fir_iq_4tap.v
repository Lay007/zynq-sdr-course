// Lab 5.2 — self-checking testbench for fir_iq_4tap
//
// Reads deterministic input and expected vectors generated by
// python/generate_fir_iq_4tap_vectors.py and verifies the RTL sample-by-sample.

`timescale 1ns/1ps

module tb_fir_iq_4tap;
...
initial begin
    ...
    if (errors == 0) begin
        $display("PASS: fir_iq_4tap test completed without errors");
        $finish;
    end else begin
        $display("FAIL: fir_iq_4tap test completed with %0d errors", errors);
        $fatal(1);
    end
end
