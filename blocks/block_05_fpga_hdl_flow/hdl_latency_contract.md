# Block 5 HDL latency contract

This file records the observable latency and throughput contract for the HDL blocks used in the Block 5 smoke tests.
...
- When an RTL pipeline is changed, this file and the matching testbench must be updated in the same change.
