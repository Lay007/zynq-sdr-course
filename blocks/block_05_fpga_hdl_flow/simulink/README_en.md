...
## Purpose
This folder is intended for Simulink models that demonstrate the key ideas of the block through reproducible scenarios for Block 5 “HDL/FPGA Flow and Xilinx Tools”.
...
- `hdl_demo.slx`
- `vivado_experiment.slx`
- `ip_core_analysis.slx`
