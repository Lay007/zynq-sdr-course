...
## Purpose
This folder is intended for schematics, KiCad projects, and electrical notes that connect the digital part of the course with real wiring and helper circuits for Block 10 “KiCad and Basic Electronics”.

## What should be stored here
- materials that directly support the block topics: KiCad interface and project structure; reading and releasing schematics; power, decoupling, and wiring;
...
- the materials should help the student reach at least one outcome of the block: schematic or schematic fragment, bill of materials.
