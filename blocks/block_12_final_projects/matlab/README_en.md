...
## Purpose
This folder is intended for numerical experiments, analysis scripts, and plot generation that can be inserted into reports for Block 12 “Final Projects”.

## What should be stored here
- materials that directly support the block topics: topic selection and success criteria; final-solution architecture; implementation plan and risk management;
...
- `final_project_analysis.m`
- `validation_sweep.m`
- `presentation_visualization.m`
...
- the materials should help the student reach at least one outcome of the block: project proposal, architecture diagram and work plan.
