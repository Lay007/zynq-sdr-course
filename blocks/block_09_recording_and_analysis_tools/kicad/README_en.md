...
## Purpose
This folder is intended for schematics, KiCad projects, and electrical notes that connect the digital part of the course with real wiring and helper circuits for Block 9 “Recording and Analysis Tools”.

## What should be stored here
- materials that directly support the block topics: IQ file formats and metadata; HDSDR for first-look observation; GNU Radio flowgraphs for analysis;
...
- the materials should help the student reach at least one outcome of the block: set of IQ recordings, format and parameter table.
