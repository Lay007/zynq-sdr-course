...
## Purpose
This folder is intended for flowgraph models that make it easy to visualize the chain, repeat captures, and validate real-time behavior for Block 8 “Modulation and Synchronization”.
