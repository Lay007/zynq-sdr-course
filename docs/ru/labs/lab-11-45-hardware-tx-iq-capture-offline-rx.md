# Lab 11.45 — ZynqSDR TX → запись IQ → офлайн-приёмник
...
После PASS этой лаборатории переходить к [Lab 11.46 — сообщение из консоли одной Zynq в консоль другой](lab-11-46-two-board-console-message.md), постепенно заменяя offline reference RX аппаратными блоками второй платы.
