...
- Синтетический захват несёт небольшое намеренное смещение DC (0,0117 полной шкалы). На приёмнике с нулевой ПЧ это пик на 0 Гц, который калибруется в Лабораторной 6.5.
- Как и в Лабораторной 6.4, ошибка 12 Гц — квантование по бинам, а «SNR» — пик над медианным бином.

### Упражнения

1. Запустите читатель на `datasets/lab6_6_zynq_rx_observation/manifest_fm_103119454.yaml` (реальный захват). Какие показатели качества меняются сильнее всего по сравнению с синтетическим файлом и почему?
2. Какие пороги `quality_pass` для смещения DC и ограничения вы бы выбрали для своего стенда?
