...
| 08 | Модуляция и синхронизация | Executable | CFO/timing, QPSK, 16-QAM, GFSK, DSSS, OFDM и packet CSS models с BER/SER/PER, EVM, PAPR, processing gain и CI-порогами | LoRa PHY и interoperability закрыты внешним проектом [zynq-lora-phy-positioning](https://github.com/Lay007/zynq-lora-phy-positioning) (валидированное декодирование записанного SX1262 IQ); оставшийся шаг в курсе — FPGA CSS/dechirp-акселератор. |
