...
| 08 | Модуляция и синхронизация | Executable | CFO, timing, BER/EVM, OFDM mini-link, OFDM PAPR/clipping и CSS dechirp/FFT models с CI-порогами метрик | Добавить packet-level CSS-синхронизацию, доказательство LoRa interoperability и FPGA-реализации. |
