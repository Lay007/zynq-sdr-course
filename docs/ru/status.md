...
| 08 | Модуляция и синхронизация | Executable | CFO, timing, BER/EVM, OFDM mini-link, OFDM PAPR/clipping, CSS dechirp/FFT и packet synchronization/PER models с CI-порогами метрик | Добавить доказательство реальной LoRa interoperability и FPGA-реализации. |
