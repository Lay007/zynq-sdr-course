...
| 08 | Модуляция и синхронизация | Executable + RTL baseline | CFO/timing, QPSK, 16-QAM, GFSK, DSSS, OFDM и packet CSS models, а также bit-exact SF7 dechirp/sequential-detector RTL-регрессия по всем символам | Компактный детектор остаётся учебным; SF5–SF12 LoRa PHY, interoperability, oversampled correlator, packet/ToA-тракт и интеграция с платой развиваются в [zynq-lora-phy-positioning](https://github.com/Lay007/zynq-lora-phy-positioning). |
