...
| 08 | Модуляция и синхронизация | Executable | CFO/timing, QPSK, 16-QAM, GFSK, DSSS, OFDM и packet CSS models с BER/SER/PER, EVM, PAPR, processing gain и CI-порогами | Добавить доказательство реальной LoRa interoperability и FPGA-реализации. |
