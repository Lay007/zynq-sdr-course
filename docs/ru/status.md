...
У каждой страницы лабораторной в Блоках 1–10 и 12 есть полная русская версия. В Блоке 11 четыре самых объёмных журнала аппаратных экспериментов (Lab 11.8, 11.26, 11.30 и 11.31) в русской редакции пока только на английском; каждая такая страница сообщает об этом в начале и ссылается на [карту лабораторных Блока 11](blocks/11-integrated-sdr-project.md), где также сказано, какие работы выполнять, а какие читать как разборы случаев.
