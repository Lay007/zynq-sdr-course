...
У каждой страницы лабораторной во всех двенадцати блоках есть полная русская версия, включая подробные хронологии аппаратных экспериментов Lab 11.8 и 11.26. [Карта лабораторных Блока 11](blocks/11-integrated-sdr-project.md) говорит, какие работы выполнять, а какие читать как разборы случаев.
