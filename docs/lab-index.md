...
| 11 | 11.1-11.46 | measured differential two-board QPSK baseline through Lab 11.45 (gross rotation 0, payload BER ~4×10⁻⁴), plus the PS/PL, recorded-IQ and application-message path toward Lab 11.46 | measured baseline / message integration pending | pass a text message between two boards and print it in the receiving console |
