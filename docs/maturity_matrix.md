...
| 05 | FPGA / HDL flow | measured / signoff-target | 29 HDL tests plus a timing-clean, board-qualified vendor-snapshot bitstream selected at WNS +0.096 ns | Demonstrate repeat-build/seed timing robustness. |
...
| 11 | Integrated SDR project | measured / portfolio-target | Lab 11.32 acquires 12/12 CFO points; Lab 11.33 retains a Costas pull-in fix and records a live-A/B rejection of a timing-closed picker candidate | Add continuous timing recovery and controlled long-duration BER-vs-attenuation statistics. |
