...
| 05 | FPGA / HDL flow | Ready | Executable | Verilog testbenches + AXI-Lite-controlled Zynq-ready BPSK BER top-level + Vivado OOC evidence | Ready | Hardware pending | HDL CI | Connect the AXI-Lite-controlled BER core to AD9363 or AXI-Stream sample I/O and collect routed plus first discovery-burst evidence. |
