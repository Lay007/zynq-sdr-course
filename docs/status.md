...
| 08 | Modulation and synchronization | Executable | CFO/timing, QPSK, 16-QAM, GFSK, DSSS, OFDM and packet CSS models with BER/SER/PER, EVM, PAPR, processing-gain and CI metric gates | Add real LoRa interoperability evidence and FPGA implementations. |
