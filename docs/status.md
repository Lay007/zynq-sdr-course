...
| `hardware/7020_ad936x_sdr/boot/build_system_bit_bin.py` | Reproducible Bootgen wrapper for runtime Linux / packaged-image `.bit.bin` payloads and manual U-Boot `fpga load` experiments. |
