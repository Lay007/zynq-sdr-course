...
| 08 | Modulation and synchronization | Executable | CFO/timing, QPSK, 16-QAM, GFSK, DSSS, OFDM and packet CSS models with BER/SER/PER, EVM, PAPR, processing-gain and CI metric gates | LoRa PHY and interoperability are covered by the external [zynq-lora-phy-positioning](https://github.com/Lay007/zynq-lora-phy-positioning) project (validated LoRa decode of recorded SX1262 IQ); the remaining in-course step is an FPGA CSS/dechirp accelerator. |
