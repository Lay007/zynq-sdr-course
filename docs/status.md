...
| 05 | FPGA / HDL flow | Executable | 18-test canonical HDL suite: BPSK/QPSK BER=0, timing recovery, AXI-Lite, dual-modem bridge and CDC FIFO | Promote routed reports for the integrated top-level design. |
