...
| `blocks/block_11_integrated_sdr_project/python/lab_11_14_stock_shell_bpsk_ota.py` | Host-driven stock-shell AD9361 fallback that transmits a deterministic OTA BPSK burst through the proven Linux TX/RX DMA path and reports BER/EVM without relying on the blocked PL overlay RX path. |
