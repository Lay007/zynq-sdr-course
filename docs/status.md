...
| 05 | FPGA / HDL flow | Measured signoff candidate | 33 HDL tests; hardware-working snapshot is fully routed at WNS +0.096 ns, and the retuned Lab 11.34 QPSK Gardner image closes at WNS +0.003 ns / WHS +0.041 ns with bit-exact model/RTL and clean-boot board verification | Challenge repeat-build/seed stability and add statistical margins to future live A/B gates. |
...
| 11 | Integrated SDR project | Continuous timing measured; baseline retained | Lab 11.32 acquires all 12 CFO points over 0–55 kHz. Lab 11.34's retuned Gardner raises full-frame lock from 193/288 to 246/288 and reaches BER=0 at all 12 CFO points, but records 71/288 clean attempts versus 72/288 for fixed sampling, so the predeclared acceptance gate rejects promotion. | Design a higher-power long-duration A/B with a statistical margin, then measure cabled/OTA BER and BER-vs-attenuation. |
