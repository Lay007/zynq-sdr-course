...
| 11 | Integrated SDR project | Measured / Hardware pending | Stock-shell BPSK fallback, runtime PL monitor evidence, RTL-SDR BER reader | Stabilize runtime PL BER, add cabled loopback, and promote a final report. |
