...
| 08 | Modulation and synchronization | Executable | CFO, timing, BER/EVM, OFDM mini-link, OFDM PAPR/clipping, CSS dechirp/FFT and packet synchronization/PER models with CI metric gates | Add real LoRa interoperability evidence and FPGA implementations. |
